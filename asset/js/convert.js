            ...
            //insert as a new product
            {
                ...
                for (let k = 32; k < 42; k++) {
                    ...
                    //first line of new product
                    {
                        ...
                        // Get product tile
                        title = cell[i][9] + ` ${partsCode}`

                        line_result = handle + "," + title + "," + body_html + "," + "Tuscany Leather" + "," + cell[i][1] + "," + "" + "," + publish_flag + "," + "Color" + "," + cell[i][10] + "," + "" + "," + "" + "," + "" + "," + "" + "," + cell[i][5] + "," + cell[i][19] * 1000 + "," + "shopify" + "," + cell[i][6] + "," + "deny" + "," + "manual" + "," + cell[i][25] + "," + "" + "," + "TRUE" + "," + "FALSE" + "," + "" + "," + cell[i][k] + "," + img_pos + "," + "" + "," + "" + "," + "" + "," + "" + "," + "" + "," + "" + "," + "" + "," + "" + "," + "" + "," + "" + "," + "" + "," + "" + "," + "" + "," + "" + "," + "" + "," + "" + "," + "" + "," + cell[i][k] + "," + "Kg" + "," + "" + "," + "" + "," + status;
                        inventory_line = handle + "," + title + "," + "Color" + "," + cell[i][10] + "," + "" + "," + "" + "," + "" + "," + "" + "," + cell[i][5] + "," + "," + "," + cell[i][6] + "," + "not stocked";
                        add_result();
                        add_inventory_result();
                    } else
